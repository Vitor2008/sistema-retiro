...
export interface Produto {
  ...
  valor: number
  estoque: number
  /** Vínculo com o catálogo global (null/ausente = produto só deste evento). */
  catalogoId?: number | null
  /** Ativo neste evento (default true quando ausente). */
  ativo?: boolean
}
...
export interface LojaProduto {
  ...
  descricao: string
  valor: number
  /** Conta de recebimento: 'imel' (padrão) ou 'outra' (recebedor externo). */
  conta: 'imel' | 'outra'
